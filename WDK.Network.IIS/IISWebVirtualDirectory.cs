...
{
    public class IISWebVirtualDirectory
    {
        ...
        internal IISWebVirtualDirectory()
        {
            _sName = "";
            _sPath = "";
        ...
        {
            var locals = new object[] {"IIS://localhost/W3SVC/", _iWebServerID, "/ROOT/", _sName};
            var directoryEntry = new DirectoryEntry(String.Concat(locals));
            directoryEntry.Properties["AppIsolated"][0] = 2;
            locals = new object[] {"/LM/W3SVC/", _iWebServerID, "/ROOT/", _sName};
        ...
        public void DeleteApplication()
        {
            var directoryEntry =
                new DirectoryEntry(
                    String.Concat(new object[] {"IIS://localhost/W3SVC/", _iWebServerID, "/ROOT/", _sName}));
