...
namespace CollectionPagerExample
{
	public class Example2 : System.Web.UI.Page
	{
		...
		//*** Make sure your UserControl is declared ***
		protected CollectionPagerExample.WebUserControl1 MyUserControl;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			CollectionPager1.BindToControl = MyUserControl.PublicRepeaterInUC;
			
			//Set the DataSource of the Repeater to the PagedData coming from the Pager.
			MyUserControl.PublicRepeaterInUC.DataSource = CollectionPager1.DataSourcePaged;
		}
