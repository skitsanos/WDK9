<%@ Page language="c#" Codebehind="Example3.aspx.cs" AutoEventWireup="false" Inherits="CollectionPagerExample.Example3" %>
...
<HTML>
	...
	<BODY bgColor="lightblue">
		...
		<P style="TEXT-ALIGN: left" runat="server">Buttons, Postback mode.</P>
		<FORM id="Form1" method="post" runat="server">
			<P><CC1:COLLECTIONPAGER id="CollectionPager1" runat="server" BackNextDisplay="Buttons" BackNextLocation="Right"
					BackText="« Back" ShowFirstLast="True" ResultsLocation="Top" PagingMode="PostBack"></CC1:COLLECTIONPAGER></P>
